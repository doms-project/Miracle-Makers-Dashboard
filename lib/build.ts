...
export const BUILD = {
  ...
  summary:
    "per-field exclusions inside a ticked folder · a warning before hiding a " +
    "field that holds values · which picker lists a pipeline · delete an empty " +
    "pipeline · contact sections shown with both names",
} as const;
